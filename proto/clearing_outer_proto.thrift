...
service ClearingService {
    ...
    /** Перевести клиринговое событие из статуса "Выполняется" в статус "Завершено" */
    void CompleteClearingEvent(1: ClearingEvent clearingEvent) throws (1: NoClearingEvent ex1)
